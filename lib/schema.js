...
export const facilityProfiles = pgTable('facility_profiles', {
  ...
  smoking_in_buildings_allowed: boolean('smoking_in_buildings_allowed'),
  allows_patient_work_program: boolean('allows_patient_work_program'),
  operates_otp: boolean('operates_otp'),
